{% macro form(form, form_class='form_vertical', title_class='', button_class='button-link', title='Подайте заявку на&nbsp;участие', button='Принять участие', form_text='', add_fields, exclude_fields) %}
